(module
  ...
  (func $__wasm_call_dtors (type 0)
    call $dummy
    call $dummy)
  (func $github.com/project-mahiwa/mahiwa-frontend-go/serial.Println (type 3) (param i32 i32)
    (local i32)
    global.get 1
    i32.const 2
    i32.eq
  ...
  (func $runtime.run$1 (type 0)
    ...
    block (result i32)  ;; label = @1
      ...
      if  ;; label = @2
        i32.const 2248
        i32.const 12
        call $github.com/project-mahiwa/mahiwa-frontend-go/serial.Println
        i32.const 0
        global.get 1
        i32.const 1
        i32.eq
    ...
    i32.add
    i32.store)
  (func $main.main$1$gowrapper (type 1) (param i32)
    (local i32)
    block (result i32)  ;; label = @1
      block (result i32)  ;; label = @2
        global.get 1
  ...
  (elem (;0;) (i32.const 1) func $runtime.run$1$gowrapper $runtime.resume$1$gowrapper $main.main$1$gowrapper $runtime.memequal $runtime.hash32)
  (data $.rodata (i32.const 2048) "\0astack overflowfree: invalid pointer\00\00\00\00\0f\08\00\00\15\00\00\00realloc: invalid pointer0\08\00\00\18\00\00\00out of memorypanic: panic: runtime error: nil pointer dereferenceindex out of rangeslice out of rangeunreachable\b5\08\00\00\0b\00\00\00main routinegoroutine")
  (data $.data (i32.const 2272) "\c1\82\01\00(\09\00\00\00\00\00\00\e0\09\00\00\c1\82\01\00\00\00\00\00\04\00\00\00\0c\00\00\00\01\00\00\00\00\00\00\00\04\00\00\00\00\00\00\00\05"))
